set tex(A) [addTexture "data/letters/letter_a.png"]
set tex(B) [addTexture "data/letters/letter_b.png"]
set tex(C) [addTexture "data/letters/letter_c.png"]
set tex(D) [addTexture "data/letters/letter_d.png"]
set tex(E) [addTexture "data/letters/letter_e.png"]
set tex(F) [addTexture "data/letters/letter_f.png"]
set tex(G) [addTexture "data/letters/letter_g.png"]
set tex(H) [addTexture "data/letters/letter_h.png"]
set tex(I) [addTexture "data/letters/letter_i.png"]
set tex(J) [addTexture "data/letters/letter_a.png"]
set tex(K) [addTexture "data/letters/letter_b.png"]
set tex(L) [addTexture "data/letters/letter_c.png"]
set tex(M) [addTexture "data/letters/letter_d.png"]
set tex(N) [addTexture "data/letters/letter_e.png"]
set tex(O) [addTexture "data/letters/letter_f.png"]
set tex(P) [addTexture "data/letters/letter_g.png"]
set tex(Q) [addTexture "data/letters/letter_h.png"]
set tex(R) [addTexture "data/letters/letter_i.png"]
set tex(S) [addTexture "data/letters/letter_a.png"]
set tex(T) [addTexture "data/letters/letter_b.png"]
set tex(U) [addTexture "data/letters/letter_c.png"]
set tex(V) [addTexture "data/letters/letter_d.png"]
set tex(W) [addTexture "data/letters/letter_e.png"]
set tex(X) [addTexture "data/letters/letter_f.png"]
set tex(Y) [addTexture "data/letters/letter_g.png"]
set tex(Z) [addTexture "data/letters/letter_h.png"]
